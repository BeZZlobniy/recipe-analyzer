    ...
    return {
        ...
        "profile_assessment": {
            ...
            "allergy_issues": {
                ...
                "status": "ok",
                "compatibility": "high",
                "summary": "Тестовый блок аллергий.",
                "evidence": [],
                "recommendations": [],
            },
            "disease_issues": {
                ...
                "status": "ok",
                "compatibility": "high",
                "summary": "Тестовый блок заболеваний.",
                "evidence": [],
                "recommendations": [],
            },
            "preference_alignment": {
                ...
                "status": "ok",
                "compatibility": "high",
                "summary": "Тестовый блок предпочтений.",
                "evidence": [],
                "recommendations": [],
            },
            "additional_restrictions": {
                ...
                "status": "ok",
                "compatibility": "high",
                "summary": "Тестовый блок ограничений.",
                "evidence": [],
                "recommendations": [],
            },
        },
